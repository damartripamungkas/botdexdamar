module.exports = {
    urlNodeBlockchain: "paste here your url node blockchain", // node blockchain rpc support ipc/http/wss, format INPUT is TEXT.
    encryptTextFromWallet: "paste here result encrypt your wallet", // AES encrypted text of your privatekey or wallet mnemonic, format INPUT is TEXT.
    allAddress: {
        addressPresale: "0x8fa71d824e2e9f0e9bdbd2a046a36948ac2a8490", // address presale to your send coin, format INPUT is address.
        addressPathSwap: ["0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c", "0xe0f94ac5462997d2bc57287ac3a3ae4c31345d66"], // address path swap, format INPUT is ARRAY(address).
    ...
    transaction: {
        ...
        botexploit: {
            ...
            optionSandwich: {
                 ...
                 * 1. bot will search for transactions according to the token address that has been set
                 * 2. bot will buy automatically with swap amount and high gwei amount with position on the same block as victim but victim's transaction must be profitable
                 * 3. after buying the bot will sell all the tokens obtained from purchases with gwei the same transaction as the victim
                 * 4. after that the bot will check whether the "delayAfterTx" setting has been filled with a numeric value then the bot will wait until it reaches the "delayAfterTx" value in seconds time format
                 * 5. after finishing number 4, the bot will work on number 1 again
                 * 
