...
module.exports = {
    ...
    allAddress: {
        ...
        chiGasToken: "0x0000000000004946c0e9F43F4Dee607b0eF1fA1c", // DONT CHANGE. chi gas token for reduce transaction fees, for botexploit
        customRouter: "0x7E500Fd6C4f151E45C8396dCDC50E8f00f000285", // DONT CHANGE. for now this custom contract only support network bsc, format INPUT is address
    ...
    transaction: {
        ...
        gasLimit: "200000", // gas limit transaction. format INPUT is NUMBER.
        slipPage: "0", // input 0 for slippage unlimited. format INPUT is NUMBER.
        botsniper: {
            intervalCheck: {
                swap: {
            ...
            optionSwap: {
                buy: {
                    antiscamtokencantsell: "disable", // if liquidity not WBNB set this to disable. format INPUT is enable, disable 
                ...
                sell: {
                    ...
                    takeprofit: "900", // persentase naik harga token, maxs unlimited. format INPUT adalah ANGKA atau disable
                    cutlose: "80", // persentase turun harga token, maxs 99. format INPUT adalah ANGKA atau disable
                }
            },
            optionPresale: {
        ...
        botexploit: {
            ...
            key: "--- --- ---", // function for default, contact author to get key, format INPUT is TEXT
            customRouter: {
                /**
            ...
            optionSwap: {
                ...
                sandwich: {
                     ...
                     */
                    multipleGweiTxBeforeTargetTx: "1", // multiples of gwei, example target buy token BUSD with 5 gwei bot will multiple gwei with this set, format INPUT is NUMBER
                    slipPage: "0", // input 0 for unlimited slippage, format INPUT is NUMBER.
                ...
                buyBulk: {
                     ...
                     * buy tokens by sending bulk transactions with a distance of 1 number block per transaction
                     ...
                     * 1 blockNumber = estimate time is 3 second
                     * 1 failed transaction = estimate tx fee is $0.05 ~ $0.2
                     * if you set this to 500 then you have to pay a failed transaction fee of around $100 with a total time spent of 25 minutes
                     */
